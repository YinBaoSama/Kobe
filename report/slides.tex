...
\begin{slide}{Data visualization}
  ...
  \begin{center}
      \includegraphics[width=.5\linewidth,height=.3\linewidth]{D:/filp/program/Kobe.git/data/locxy.eps}
  \end{center}
...
\begin{slide}{Data visualization}
   ...
   \begin{center}
      \includegraphics[width=.5\linewidth,height=.3\linewidth]{D:/filp/program/Kobe.git/data/shotzone.eps}
   \end{center}
...
\begin{slide}{Data visualization}
  ...
  \begin{center}
     \includegraphics[width=.5\linewidth,height=.3\linewidth]{D:/filp/program/Kobe.git/data/shotarea.eps}
  \end{center}
...
\begin{slide}{Data visualization}
  ...
  \begin{center}
     \includegraphics[width=.5\linewidth,height=.3\linewidth]{D:/filp/program/Kobe.git/data/attack.eps}
  \end{center}
...
\begin{slide}{Data visualization}
  ...
  \begin{center}
     \includegraphics[width=.5\linewidth,height=.3\linewidth]{D:/filp/program/Kobe.git/data/getpoint.eps}
  \end{center}
...
\begin{slide}{Data visualization}
  ...
  \begin{center}
     \includegraphics[width=.5\linewidth,height=.3\linewidth]{D:/filp/program/Kobe.git/data/shotnumber.eps}
  \end{center}
...
\begin{slide}{Data visualization}
  ...
  \begin{center}
     \includegraphics[width=.5\linewidth,height=.3\linewidth]{D:/filp/program/Kobe.git/data/period.eps}
  \end{center}
...
\begin{slide}{Data visualization}
  ...
  \begin{center}
     \includegraphics[width=.5\linewidth,height=.3\linewidth]{D:/filp/program/Kobe.git/data/final.eps}
  \end{center}
...
\begin{itemize}
 ...
 \item
 \textcolor{blue}{Choose the minimum value of loss and the number of optimal trees, the optimal value of maximum depth.}
...
\begin{slide}{Build and train the model and produce the submission data}
  ...
  \begin{center}
      \includegraphics[width=.5\linewidth,height=.3\linewidth]{D:/filp/program/Kobe.git/data/deptree.eps}
   \end{center}
